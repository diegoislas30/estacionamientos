...
ENDPOINT_UPLOAD = "https://endpoints.caabsa.com/SucursalesSINUBE_API/uploadSINUBE_181_HOTEL_NH"
SUCURSAL_HEADER = "181 HOTEL NH"  # ← actualizado
...
def main():
    ...
    plaza_id = buscar_carpeta_id(service, "59. 181-HOTEL NH", raiz_id)  # ← actualizado
