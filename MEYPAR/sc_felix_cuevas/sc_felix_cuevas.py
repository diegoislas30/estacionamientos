...
ENDPOINT_UPLOAD = "https://endpoints.caabsa.com/SucursalesSINUBE_API/uploadSINUBE_MEYPAR"
SUCURSAL_HEADER = "44 SC FELIX CUEVAS"  # ← actualizado
...
MESES_ATRAS = 1              # ← Cantidad de meses atrás en modo automático
...
def main():
    ...
    plaza_id = buscar_carpeta_id(service, "28. 044-SC FELIX CUEVAS", raiz_id)
    if not plaza_id:
