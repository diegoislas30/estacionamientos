...
ENDPOINT_UPLOAD = "https://endpoints.caabsa.com/SucursalesSINUBE_API/uploadSINUBE_162_AMAZONAS"
SUCURSAL_HEADER = "162 AMAZONAS"  # ← actualizado
...
def main():
    ...
    plaza_id = buscar_carpeta_id(service, "40. 162-AMAZONAS", raiz_id)  # ← actualizado
