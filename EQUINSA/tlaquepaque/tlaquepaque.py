...
ENDPOINT_UPLOAD = "https://endpoints.caabsa.com/SucursalesSINUBE_API/upload147Tlaquepaque"
SUCURSAL_HEADER = "147 CB TLAQUEPAQUE"
...
def main():
    ...
    plaza_id = buscar_carpeta_id(service, "33. 147-COMBO TLAQUEPAQUE", raiz_id)
