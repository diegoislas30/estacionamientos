...
SUCURSAL_HEADER = "31 METROPOLI PATRIOT"
...
def main():
    ...
    plaza_id = buscar_carpeta_id(service, "45. 031-METROPOLI PATRIOTISMO", raiz_id)
    ...
    for archivo in archivos:
        ...
        if subir_archivo(ENDPOINT_UPLOAD, nombre_local, SUCURSAL_HEADER):
            nuevo_nombre_drive = (
                nombre_original[:-5] + "_procesado.xlsx"
                if nombre_original.lower().endswith(".xlsx")
                else nombre_original + "_procesado"
            )
