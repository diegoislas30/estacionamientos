...
SUCURSAL_HEADER = "146 CB MARIANO OTERO"
...
def main():
    ...
    plaza_id = buscar_carpeta_id(service, "32. 146-COMBO MARIANO OTERO", raiz_id)
    ...
    for archivo in archivos:
        ...
        if subir_archivo(ENDPOINT_UPLOAD, nombre_local, SUCURSAL_HEADER):
            # Renombrado en Drive a *_procesado.xlsx (si aplica)
