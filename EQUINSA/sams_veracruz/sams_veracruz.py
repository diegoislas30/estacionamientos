...
SUCURSAL_HEADER = "143 SAMS VERACRUZ"
...
MESES_INV = {v.upper(): k for k, v in MESES_ES.items()}  # "AGOSTO" -> 8
...
def main():
    ...
    plaza_id = buscar_carpeta_id(service, "5. 143-SAMS VERACRUZ", raiz_id)
    ...
    for archivo in archivos:
        ...
        if subir_archivo(ENDPOINT_UPLOAD, nombre_local, SUCURSAL_HEADER):
            # Renombrado en Drive a *_procesado.xlsx (robusto)
