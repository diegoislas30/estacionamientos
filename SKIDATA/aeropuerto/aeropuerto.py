...
ENDPOINT_UPLOAD = "https://endpoints.caabsa.com/SucursalesSINUBE_API/upload024PlazaAereopuerto"
SUCURSAL_HEADER = "24 PLAZA AEROPUERTO"  # ← actualizado
...
def main():
    ...
    plaza_id = buscar_carpeta_id(service, "12. 024-PLAZA AEROPUERTO", raiz_id)  # ← actualizado
